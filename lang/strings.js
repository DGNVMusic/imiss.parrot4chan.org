...
AllStrings["en"] = {
    CommonMetadata: {
        HeaderSMTitle: "I MISS PARROT",
        FooterText: "Not affiliated with Parrot or hololive - Past stream data provided by Holodex - {0}",
        FooterSourceLink: "Source",
        FooterStreamerLink: "Parrot4Chan"
    },

    Main: {
        PageTitle: "I MISS PARROT",
        DontMissCaption: "I Don't Miss Parrot",
        ImageAlt: "Meme",
        RandomVodLink: "Do your reps",
        ErrorMessageChannelLink: "You can check Parrot's channel yourself",
    ...
    VideoBox: {
        ...
        NoStreamDummyTitle: "NOTHING XD LMAO",
        MembersOnlySubtext: "(for Schizos only!)",
        ThumbnailAltText: "Video Thumbnail"
    },

    Reps: {
        PageTitle: "Do your reps!",
        SMMetaDescription: "Get a random Parrot VOD to watch!",
